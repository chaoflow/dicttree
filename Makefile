...
check-imports:
	./bin/python -c 'import metachao; print metachao.__file__'
	./bin/python -c 'import dicttree; print dicttree.__file__'

test-nose: bin/nosetests
	rm -f .coverage
	./bin/nosetests -w . --with-cov --cover-branches --cover-package=metachao --cover-package=dicttree
